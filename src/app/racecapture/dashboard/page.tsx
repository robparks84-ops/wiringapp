...
import { useAuth } from '@/contexts/PodiumAuthContext';
import { TelemetryProvider, useTelemetry } from '@/contexts/TelemetryContext';
import type { WidgetConfig, GridItem, AlarmRule, DashboardLayout } from '@/lib/racecaptureTypes';
import DashboardGrid from '@/components/racecapture/DashboardGrid';
import ChannelPicker from '@/components/racecapture/ChannelPicker';
import DeltaTimer from '@/components/racecapture/DeltaTimer';
import TrackMap from '@/components/racecapture/TrackMap';
import AlarmBanner from '@/components/racecapture/AlarmBanner';
import FuelWidget from '@/components/racecapture/FuelWidget';
import LapSelector from '@/components/racecapture/LapSelector';
import CriticalAlertOverlay from '@/components/racecapture/CriticalAlertOverlay';
import StintPanel from '@/components/racecapture/StintPanel';
import FlagDisplay from '@/components/racecapture/FlagDisplay';
import ChampcarMap from '@/components/racecapture/ChampcarMap';
import SpeedhivePanel from '@/components/racecapture/SpeedhivePanel';
import MathChannelEditor from '@/components/racecapture/MathChannelEditor';
import SystemStatus from '@/components/racecapture/SystemStatus';
...
function DashboardContent() {
  ...
  useEffect(() => {
    if (!token) { router.replace('/racecapture'); return; }
        ...
        <Group gap={6}>
          ...
          <Menu shadow="md" width={180}>
            ...
            <Menu.Dropdown>
              ...
              <Menu.Divider />
              <Menu.Item color="red" leftSection={<IconLogout size={12} />} onClick={() => { logout(); router.replace('/racecapture'); }}>
                Sign out
              </Menu.Item>
            </Menu.Dropdown>
          </Menu>
